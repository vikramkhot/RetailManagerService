...
import com.example.model.GoogleResponse;
	...
	public static void main(String[] args) throws IOException {
		...
		if (res.getStatus().equals("OK")) {
			for (Result result : res.getResults()) {
				System.out.println("Lattitude of address is :" + result.getGeometry().getLocation().getLatitude());
				System.out.println("Longitude of address is :" + result.getGeometry().getLocation().getLongitude());
